   ...
   */
   ...
   public Time(String militaryTime)
   {
      ...
      else
      {
         ...
         // are digits
         else if (Integer.parseInt(militaryTime.substring(0, 2)) < 00)
         {
            System.out.println(militaryTime +
                               " is not a " +
                               "valid miliary time." );
         }
         else if (Integer.parseInt(militaryTime.substring(0, 2)) > 23)
         {
            System.out.println(militaryTime +
                               " is not a " +
                               "valid miliary time." );
         }
         else if (Integer.parseInt(militaryTime.substring(3, 5)) < 00)
         {
            System.out.println(militaryTime +
                               " is not a " +
                               "valid miliary time." );
         }
         else if (Integer.parseInt(militaryTime.substring(3, 5)) > 59)
         {
            System.out.println(militaryTime +
                               " is not a " +
                               "valid miliary time." );
